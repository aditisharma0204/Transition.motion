...
export default {
  ...
  settings: [
    { id: 'animType', label: 'Animation Type', type: 'select', default: 'pulse', options: [
      ...
      { value: 'morph-pulse-grow', label: 'Morph (Pulse → Grow on Hover)' }
    ] },
...
<style>
  ...
  @keyframes anim-pulse {
    ...
    50% { background-color: var(--dot-glow); box-shadow: 0 0 10px 0 var(--dot-shadow); transform: scale(1.1); }
  }
  ...
  /* 5. GROWING */
  @keyframes anim-growing {
    0%, 100% { transform: scale(0.2); background-color: var(--dot-base); box-shadow: none; opacity: 0; }
    40%, 60% { transform: scale(1); background-color: var(--dot-glow); box-shadow: 0 0 10px 0 var(--dot-shadow); opacity: 1; }
  }
  .dot-matrix.growing > div { animation: anim-growing 2s infinite ease-in-out; }
  .dot-matrix.growing > div:nth-child(1) { animation-delay: 0s; }
  .dot-matrix.growing > div:nth-child(2) { animation-delay: 0.1s; }
  .dot-matrix.growing > div:nth-child(3) { animation-delay: 0.2s; }
  .dot-matrix.growing > div:nth-child(4) { animation-delay: 0.3s; }
  .dot-matrix.growing > div:nth-child(5) { animation-delay: 0.4s; }
  .dot-matrix.growing > div:nth-child(6) { animation-delay: 0.5s; }
  .dot-matrix.growing > div:nth-child(7) { animation-delay: 0.6s; }
  .dot-matrix.growing > div:nth-child(8) { animation-delay: 0.7s; }
  .dot-matrix.growing > div:nth-child(9) { animation-delay: 0.8s; }
</style>
</head>
<body>
